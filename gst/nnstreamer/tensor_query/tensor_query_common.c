 ...
 */
int
nnstreamer_query_connect (void * connection, const char *ip, uint32_t port,
    uint32_t timeout_ms)
{
 ...
 */
int
nnstreamer_query_receive (void * connection, TensorQueryCommandData * data,
    uint32_t timeout_ms)
{
 ...
 */
int
nnstreamer_query_send (void * connection, TensorQueryCommandData * data,
    uint32_t timeout_ms)
{
  TensorQueryConnection *conn = (TensorQueryConnection *) connection;
  UNUSED (timeout_ms);
 ...
 * @return void* casted type of TensorQueryServerData*
 */
void *
nnstreamer_query_server_data_init (void)
{
  TensorQueryServerData *sdata = g_new (TensorQueryServerData, 1);
 ...
 */
int
nnstreamer_query_server_data_setup (void *server_data,
